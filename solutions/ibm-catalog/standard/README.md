...
| <a name="input_private_subnet_3"></a> [private\_subnet\_3](#input\_private\_subnet\_3) | Configure this input to create a new subnet for your instance. Follow the example format provided. To skip subnet creation, set this value to null.<br/>  Example:<br/>    {<br/>      name = "vtl\_subnet"<br/>      cidr = "10.70.0.0/24"<br/>      ip   = "10.70.0.21"<br/>    } | <pre>object({<br/>    name = string<br/>    cidr = string<br/>    ip   = optional(string)<br/>  })</pre> | `null` | no |
| <a name="input_private_subnet_4"></a> [private\_subnet\_4](#input\_private\_subnet\_4) | Configure this input to create a new subnet for your instance. Follow the example format provided. To skip subnet creation, set this value to null.<br/>  Example:<br/>    {<br/>      name = "vtl\_subnet"<br/>      cidr = "10.70.0.0/24"<br/>      ip   = "10.70.0.21"<br/>    } | <pre>object({<br/>    name = string<br/>    cidr = string<br/>    ip   = optional(string)<br/>  })</pre> | `null` | no |
