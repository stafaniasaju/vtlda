...
| Name | Type |
|------|------|
| [ibm_pi_network.pi_private_subnet_3](https://registry.terraform.io/providers/IBM-Cloud/ibm/1.76.3/docs/resources/pi_network) | resource |
| [ibm_pi_network.pi_private_subnet_4](https://registry.terraform.io/providers/IBM-Cloud/ibm/1.76.3/docs/resources/pi_network) | resource |
...
| <a name="input_pi_private_subnet_3"></a> [pi\_private\_subnet\_3](#input\_pi\_private\_subnet\_3) | Configuration for a third private subnet. Set to null to skip creating this subnet. | <pre>object({<br/>    name = string<br/>    cidr = string<br/>    ip   = optional(string)<br/>  })</pre> | `null` | no |
| <a name="input_pi_private_subnet_4"></a> [pi\_private\_subnet\_4](#input\_pi\_private\_subnet\_4) | Configuration for a third private subnet. Set to null to skip creating this subnet. | <pre>object({<br/>    name = string<br/>    cidr = string<br/>    ip   = optional(string)<br/>  })</pre> | `null` | no |
